...
**Archived 2026-09-22.** Version- and package-name-pinned to 0.4.0 (the package name
has since changed; current test counts and process live in
[`docs/guides/TESTING-GUIDE.md`](../guides/TESTING-GUIDE.md) and
[`docs/guides/RELEASE-RUNBOOK.md`](../guides/RELEASE-RUNBOOK.md)). Kept as a worked
example of a manual E2E test plan.
